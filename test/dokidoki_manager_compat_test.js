...
assert.match(dokidoki, /@media \(min-width:1320px\)/);
assert.match(dokidoki, /width:84px;height:126px/);
assert.match(dokidoki, /width:64px;height:96px/);

assert.match(manager, /\/\/ @version\s+0\.3\.3\.0/);
assert(manager.includes("const ADDON_VERSION = '0.3.3.0'"));
