...
assert.match(manager, /\/\/ @version\s+0\.3\.5\.0/);
assert(manager.includes("const ADDON_VERSION = '0.3.5.0'"));
...
assert.match(manager, /\.hvmepp-upgrade-matrix-wrap\{[^}]*overflow:auto/);
