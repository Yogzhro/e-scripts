...
<div class="hvut-side hvut-ml-side"><input type="button" value="Gift Summary"><input id="hvut-ml-up-button" type="button" value="Monster Upgrader"><input type="button" value="Power Level Calculator"></div>
<div id="monster_list"><div id="slot_pane">
<div class="msl"><div>199</div><div>Fixture Alpha</div><div>PL 0</div><div>Arthropod</div></div>
<div class="msl"><div>200</div><div>Fixture Beta</div><div>PL 0</div><div>Dragonkin</div></div>
